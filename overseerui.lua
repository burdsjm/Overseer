    ...
    if ImGui.BeginTabItem("General") then
        ...
        elseif (overseer.TutorialIsRequired == true) then
            ...
            elseif (MinutesUntilNextQuest ~= nil and MinutesUntilNextQuest == 0) then
                ...
                ImGui.Text("Quests are completed and pending collection")
                ImGui.PopStyleColor(1)
        ...
        if ImGui.CollapsingHeader('Overseer Claims (Inventory)') then
            ...
            if ImGui.BeginTable('##tableClaims', 3, flags, 0, TEXT_BASE_HEIGHT, 0.0) then
                ...
                ImGui.TableSetupColumn('Padding',
                    bit32.bor(ImGuiTableColumnFlags.NoSort, ImGuiTableColumnFlags.WidthAuto), -1.0, 1)
...
function RenderSettingsGeneralTab()
    if ImGui.BeginTabItem("General") then
        ...
        ImGui.Separator()
        uiutils.text_colored(TextStyle.SubSectionTitle, 'General Settings')
        ImGui.Separator()
        ...
        ImGui.Separator()
        uiutils.text_colored(TextStyle.SubSectionTitle, "Claim Settings")
        ImGui.Separator()
        RenderSettingsRewardsGeneralSection()

        ImGui.Separator()
        uiutils.text_colored(TextStyle.SubSectionTitle, "Ignore Specific Quests")
        ImGui.Separator()
        ...
        ImGui.Separator()
        uiutils.text_colored(TextStyle.SubSectionTitle, "Agents Required Before Conversion")
        ImGui.Separator()
        ...
        if Settings.General.agentCountForConversionCommon ~= nil then
            ...
            if Settings.General.agentCountForConversionCommon < 1 then Settings.General.agentCountForConversionCommon = 1 end
            if (changed) then settings.SaveSettings() end
            ...
            if Settings.General.agentCountForConversionUncommon < 1 then Settings.General.agentCountForConversionUncommon = 1 end
            if (changed) then settings.SaveSettings() end
            ...
            if Settings.General.agentCountForConversionRare < 1 then Settings.General.agentCountForConversionRare = 1 end
            if (changed) then settings.SaveSettings() end
            ...
            if (Settings.General.convertEliteAgents) then
                ...
                if Settings.General.agentCountForConversionElite < 1 then Settings.General.agentCountForConversionElite = 1 end
                if (changed) then settings.SaveSettings() end
            end
        end

        ImGui.Separator()
        uiutils.text_colored(TextStyle.SubSectionTitle, "Quest Mode")
        ImGui.Separator()
        ...
        ImGui.Separator()
        uiutils.text_colored(TextStyle.SubSectionTitle, "Reward Claim")
        ImGui.Separator()
        ...
        ImGui.Separator()
        uiutils.text_colored(TextStyle.SubSectionTitle, 'UI Actions')
        ImGui.Separator()
        ...
        ImGui.Separator()
        uiutils.text_colored(TextStyle.SubSectionTitle, 'Display')
        ImGui.Separator()
...
function RenderSettingsQuestsSimpleSection(priorityName, config)
    local changed
    uiutils.text_colored(TextStyle.SubSectionTitle, 'Durations')
    ...
    ImGui.Separator()
    uiutils.text_colored(TextStyle.SubSectionTitle, 'Levels')
    if (ShowDetailedUI()) then
        ImGui.SameLine()
    ...
    ImGui.Separator()
    uiutils.text_colored(TextStyle.SubSectionTitle, 'Rarities')
    if (ShowDetailedUI()) then
        ImGui.SameLine()
    ...
    ImGui.Separator()
    uiutils.text_colored(TextStyle.SubSectionTitle, 'Types')
    if (ShowDetailedUI()) then
        ImGui.SameLine()
...
function RenderSettingsSpecificQuestSection()
    if ImGui.BeginTabItem("Specific") then
        ImGui.Separator()
        uiutils.text_colored(TextStyle.SubSectionTitle, 'Run Achievement Quests')
        ImGui.Separator()
        ...
        ImGui.Separator()
        uiutils.text_colored(TextStyle.SubSectionTitle, 'Run Specific Quest By Name')
        ImGui.Separator()
        ...
        uiutils.text_colored(TextStyle.ItemLabelHint, 'Opt. Dark Deeds')
